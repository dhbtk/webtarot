...
import { getInterpretation, getUser as apiGetUser, logIn as apiLogIn, updateUser as apiUpdateUser } from './api.ts'
...
export const useCurrentUserQuery = () => queryOptions<User>({
  queryKey: ['auth'],
...
export const useUpdateUserMutation = () => mutationOptions<User, Error, UpdateUserRequest>({
  mutationKey: ['auth'],
